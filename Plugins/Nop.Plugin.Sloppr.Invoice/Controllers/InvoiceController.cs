...
using Nop.Plugin.Sloppr.Invoice.Models;

namespace Nop.Plugin.Sloppr.Invoice.Controllers
{
    public class InvoiceController : BasePluginController
    {
        private readonly string _viewFolderPath = "~/Plugins/Sloppr.Invoice/Views/Invoice";
